...
const VERSION = 'blog-1.2.0';
const SHELL = ['./', './index.html', './beerxml.js?v=1.2.0', './data.js?v=1.2.0', './shop.js?v=1.2.0', './core.js?v=1.2.0', './app.js?v=1.2.0', './manifest.webmanifest?v=1.2.0', './icons/icon-192.png', './icons/icon-512.png'];
