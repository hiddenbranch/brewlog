...
const VERSION = 'blog-1.3.0';
const SHELL = ['./', './index.html', './recipes.js?v=1.3.0', './beerxml.js?v=1.3.0', './data.js?v=1.3.0', './shop.js?v=1.3.0', './core.js?v=1.3.0', './app.js?v=1.3.0', './manifest.webmanifest?v=1.3.0', './icons/icon-192.png', './icons/icon-512.png'];
